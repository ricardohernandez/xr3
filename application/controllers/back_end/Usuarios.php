	...
	//PROYECTOS
		...
		public function vistaProyectos(){
			if($this->input->is_ajax_request()){
				...
				$this->load->view('back_end/usuarios/proyectos',$datos);
			}
		}
	...
	//AREAS
		...
		public function vistaAreas(){
			if($this->input->is_ajax_request()){
				...
				$this->load->view('back_end/usuarios/areas',$datos);
			}
		}
	...
	//JEFES
		...
		public function vistaJefes(){
			if($this->input->is_ajax_request()){
				...
				$this->load->view('back_end/usuarios/jefes',$datos);
			}
		}
	...
	//PERFILES
		...
		public function vistaPerfiles(){
			if($this->input->is_ajax_request()){
				...
				$this->load->view('back_end/usuarios/perfiles',$datos);
			}
		}
	...
	/*********HERRAMIENTAS************/
	    ...
	    public function vistaHerramientas(){
			...
			if($this->input->is_ajax_request()){
				...
				$this->load->view('back_end/usuarios/herramientas',$datos);
			}
		}
