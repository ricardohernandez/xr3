...
$lang['less_than_equal_to'] = "El campo %s debe contener un número inferior o igual a %s.";
$lang['greater_than_equal_to'] = "El campo %s debe contener un número superior o igual a %s.";
