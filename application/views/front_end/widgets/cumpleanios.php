	...
	<?php  
      ...
      if($c["dia_actual"] == $dia_actual){
        ...
        <?php 
	          ...
	          if($c["dia_actual"] == $dia_actual){
	            ?>
	              <a href="#!" class="enlace_activo_cumple"><?php echo $c["nombre_corto"]?> - <?php echo mb_strimwidth($c["proyecto"], 0, 30, '...')." - ".$c["plaza"]." - ".$c["subzona"]; ?></a>
	            ...
	            ?>
	              <a href="#!"><?php echo $c["nombre_corto"]?> - <?php echo mb_strimwidth($c["proyecto"], 0, 30, '...')." - ".$c["plaza"]." - ".$c["subzona"]; ?></a>
