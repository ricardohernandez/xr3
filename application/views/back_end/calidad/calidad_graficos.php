	...
	var tabla_resumen_calidad = $('#tabla_resumen_calidad').DataTable({
		...
		"footerCallback": function(row, data, start, end, display) {
			...
			for (var i = 1; i <= (largo); i++) {
				...
				if (i == 4) {
					v1 = api.column(2).data().reduce(function(a, b) {
						return intVal(a) + intVal(b);
					}, 0);
					v2 = api.column(3).data().reduce(function(a, b) {
						return intVal(a) + intVal(b);
					}, 0);
					avg = (v2 / v1) * 100;
				...
				if (i == 7) {
					v1 = api.column(5).data().reduce(function(a, b) {
						return intVal(a) + intVal(b);
					}, 0);
					v2 = api.column(6).data().reduce(function(a, b) {
						return intVal(a) + intVal(b);
					}, 0);
					avg = (v2 / v1) * 100;
