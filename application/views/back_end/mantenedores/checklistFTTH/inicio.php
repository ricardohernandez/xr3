...
<script type="text/javascript">
  $(function(){
        ...
        $("#menu_checklistFTTH").addClass('disabled_sub');
        $(".contenedor_app").html("<center><i id='processingIcon' class='fa-solid fa-circle-notch fa-spin fa-2x'></i></center>");
        $(".menu_lista li").removeClass('menuActivo');    
        $("#menu_checklistFTTH").addClass('menuActivo');  
       

        $.get("vistaMantChecklistFTTH", function( data ) {
          $(".contenedor_app").html(data);    
          $("#menu_checklistFTTH").removeClass('disabled_sub');
        });


      $(document).off('click', '#menu_checklistFTTH').on('click', '#menu_checklistFTTH',function(event) {
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       <ul class="nav nav-tabs navbar-left nav-tabs-int menu_lista">
        <li id="menu_checklistFTTH" class="active"><a> <i class="fa fa-th-list"></i> Mant. Checklist FTTH</a></li>
      </ul>  
    </div> 
  </div>
