   ...
   ?>
    <div id="header" class="header">
     <div class="header-logo">
       <img src="https://xr3t.cl/assets3/imagenes/logo2.png" style="width:110px;height: 46px!important">
        <span style="position:absolute;font-size: 12px;margin-left: 20px;margin-top:0px!important;font-weight: bold;text-decoration: underline;"><?php  echo $titulo  ?></span>
      </div>    
    </div>
    ...
    <div id="content">
      ...
      <table  class="table table-sm" border="0" cellpadding="0" cellspacing="0" style="margin-top:-15px!important;">
       <thead>
         <tr class="">     
            <td width="15%" class="text-center color_xr3" style="padding: 4px!important;font-size: 10px!important;"><b>Tipo</b></td>
            <td width="70%" class="text-center color_xr3" style="padding: 4px!important;font-size: 10px!important;"><b>Descripci&oacute;n</b></td>  
            <td width="15%" class="text-center color_xr3" style="padding: 4px!important;font-size: 10px!important;"><b>Resultado</b></td>
          ...
          <?php
            if($detalle!=FALSE){
             foreach ($detalle as $det) {  
                ...
                if($det["estado_str"] == "no"){
                  $clase = "rojo";
                }elseif($det["estado_str"] == "no_ap"){
                  $clase = "gris";
                }else{
                  $clase = "verde";
                }
                ...
                if($det["id_tipo"]=="2"){
                  ...
                  if($det["estado_str"]=="si"){
                     $opcion = "Controlado";  
                  }elseif($det["estado_str"]=="no"){
                     $opcion = "No controlado";  
                  }else{
                     $opcion = "No aplica";  
                  }
                   
                }elseif($det["id_tipo"]<>"2"){
