<script type="text/javascript">
  ...
  $(function(){
    ...
    $("#menu_es").addClass('disabled_sub');

	  $(".contenedor_app").html("<center><i id='processingIcon' class='fa-solid fa-circle-notch fa-spin fa-2x'></i></center>");

	  $(".menu_lista li").removeClass('menuActivo');       

	  $("#menu_es").addClass('menuActivo');  



    $.get(base_url+"getEsInicio", function( data ) {

        $(".contenedor_app").html(data);    

        $("#menu_es").removeClass('disabled_sub');
    ...
    $(document).off('click', '#menu_es').on('click', '#menu_es',function(event) {
  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <div class="scrollable-menu">
       ...
       <li id="menu_es" class="active"><a> <i class="fa fa-list-alt"></i> Listado requerimientos</a></li>   
