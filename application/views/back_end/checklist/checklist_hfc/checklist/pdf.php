      ...
      <table  class="table table-sm" border="0" cellpadding="0" cellspacing="0" style="margin-top:-15px!important;">
       <thead>
         <tr class="">     
            ...
            <td width="60%" class="text-center color_xr3" style="padding: 4px!important;font-size: 10px!important;"><b>Descripci&oacute;n</b></td>  
            <td width="15%" class="text-center color_xr3" style="padding: 4px!important;font-size: 10px!important;"><b>Res.</b></td>
