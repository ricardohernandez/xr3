...
<script type="text/javascript">
	...
	/* google.charts.setOnLoadCallback(graficoEstadosChecklistCH); */
	google.charts.setOnLoadCallback(graficoTecnicosCH);
	google.charts.setOnLoadCallback(graficoTecnicosCH);
	...
	google.charts.setOnLoadCallback(graficoAuditoresCH);
	...
	function graficoAuditoriasq(){
	    ...
	    $.ajax({
        url: base_url+"graficoAuditoriasDataCHQ"+"?"+$.now(),  
        type: 'POST',
	...
	function graficoAuditorias(){
	    ...
	    $.ajax({
        url: base_url+"graficoAuditoriasDataCH"+"?"+$.now(),  
        type: 'POST',
        data:{'auditor_gm':auditor_gm,'zona_gm':zona_gm,'comuna_gm':comuna_gm},
        dataType:"json",
        success: function (json) {
	...
	function graficoAuditoriasTecnicosq(){
	    ...
	    $.ajax({
        url: base_url+"graficoAuditoriasDataCHTecnicoQ"+"?"+$.now(),  
        type: 'POST',
	...
	function graficoAuditoriasTecnicos(){
	    ...
	    $.ajax({
        url: base_url+"graficoAuditoriasDataCHTecnico"+"?"+$.now(),  
        type: 'POST',
        data:{'tecnico_gmt':tecnico_gmt,'zona_gmt':zona_gmt,'comuna_gmt':comuna_gmt},
        dataType:"json",
        success: function (json) {
	...
	function graficoTecnicosCH(){
	    $.ajax({
        url: base_url+"dataTecnicosChecklistCH"+"?"+$.now(),  
        type: 'POST',
        data:{},
        dataType:"json",
        success: function (json) {
	...
	function graficoAuditoresCH(){
	    $.ajax({
        url: base_url+"dataAuditoresChecklistCH"+"?"+$.now(),  
        type: 'POST',
        data:{},
        dataType:"json",
        success: function (json) {
    ...
    function graficoEstadosChecklistCH(){
	    $.ajax({
        url: base_url+"dataEstadosChecklistCH"+"?"+$.now(),  
        type: 'POST',
        data:{},
        dataType:"json",
        success: function (json) {
