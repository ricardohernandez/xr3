...
<script type="text/javascript" charset="utf-8"> 
  $(function(){ 
    ...
    /*****DATATABLE*****/  
      ...
      var tb_ingresos = $('#tb_ingresos').DataTable({
         ...
         columnDefs: [
          ...
          "ajax": {
            ...
            "dataSrc": function (json) {
              $(".btn_filtro").html('<span class="glyphicon glyphicon-refresh"></span> Filtrar');
    ...
    $(document).on('keyup paste', '#buscador', function() {
      tb_ingresos.search($(this).val().trim()).draw();
    });
    ...
    setTimeout( function () {
      var tb_ingresos = $.fn.dataTable.fnTables(true);
      if ( tb_ingresos.length > 0 ) {
          $(tb_ingresos).dataTable().fnAdjustColumnSizing();
    }}, 200 ); 
...
<!--FILTROS-->
  ...
  <div class="form-row">
      ...
      <div class="col-md-2">
	    ...
	    <div class="col-2 col-lg-2">
	       <div class="form-group">
	          <button type="button" class="btn-block btn btn-sm btn-outline-primary btn-primary btn_filtro btn_xr3">
  ...
  <div class="row">
    <div class="col-12">
      <table id="tb_ingresos" class="table table-striped table-hover table-bordered dt-responsive nowrap" style="width:100%!important">
          <thead>
            <tr>
    ...
    <div id="modal_ingreso"  class="modal fade bd-example-modal-lg" data-backdrop="static"   aria-labelledby="myModalLabel" role="dialog">
	    <div class="modal-dialog modal_ingreso">
	      <div class="modal-content">
	        <?php echo form_open_multipart("formIngreso",array("id"=>"formIngreso","class"=>"formIngreso"))?>
