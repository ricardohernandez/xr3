...
<script type="text/javascript" charset="utf-8"> 
  $(function(){ 
        ...
        $.ajax({
          ...
          success: function (data) {
            if(data.res=="ok"){
              ...
              $("#formRvt input,#formRvt select,#formRvt button,#formRvt").prop("disabled", false);
              $(".solicitud_cont").prop("disabled", true).trigger('change');
              $(".solicitud_cont select").prop("disabled", true).trigger('change');
              $(".solicitud_cont .select2-selection--single").addClass("readonly");
    ...
    $(document).off('click', '.btn_excel_rop').on('click', '.btn_excel_rop',function(event) {
      ...
      const estado_f = estado === "" ? "-" : estado.replace(/ /g, "_");

      window.location="excel_rvt/"+desde+"/"+hasta+"/"+estado_f;
    });
      ...
      <div class="col-6 col-lg-1">  
        <div class="form-group">
          <select id="estado_f" name="estado_f" class="custom-select custom-select-sm">
            <option selected value="" >Estado | Todos</option>
	    ...
	    <div class="modal-dialog modal_rop">
	      <div class="modal-content">
	        <?php echo form_open_multipart("formRvt",array("id"=>"formRvt","class"=>"formRvt"))?>
	           ...
	           <fieldset class="form-ing-cont solicitud_cont">
