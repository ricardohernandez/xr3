<script type="text/javascript">
  $(function(){
    ...
    vistaPrevencionModulos()

    function vistaPrevencionModulos(){
      $("#menu_prevencion_modulos").addClass('disabled_sub');
      $(".contenedor_app").html("<center><i id='processingIcon' class='fa-solid fa-circle-notch fa-spin fa-2x' ></i></center>");
      $(".menu_lista li").removeClass('menuActivo');       
      $("#menu_prevencion_modulos").addClass('menuActivo');  

      $.get(base_url+"vistaPrevencionModulos", {"tipo" : tipo },function( data ) {
        $(".contenedor_app").html(data);    
        $("#menu_prevencion_modulos").removeClass('disabled_sub');
      });
  ...
  <!-- <div class="row">
    ...
    <div class="scrollable-menu">
       <ul class="nav nav-tabs navbar-left nav-tabs-int menu_lista">
        <li id="menu_prevencion_modulos" class="active"><a> <i class="fa fa-list-alt"></i> menu_prevencion_modulos </a></li>   
