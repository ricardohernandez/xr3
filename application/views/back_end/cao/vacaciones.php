  ...
  <div class="form-row">
	  <div class="col-1 col-lg-1"> 
	      <div class="form-group">
	         <button type="button" class="btn-block btn btn-sm btn-outline-primary btn_nuevo_vacaciones btn_xr3">
           ...
           <fieldset class="form-ing-cont">
            ...
            <div class="col-lg-8 offset-lg-2">
              <div class="form-row">
                ...
                <div class="col-6 col-lg-6">
                  <button class="btn-block btn btn-sm btn-dark cierra_modal_vacaciones" data-dismiss="modal" aria-hidden="true">
